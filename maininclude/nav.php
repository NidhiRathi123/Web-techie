<nav class="navbar navbar-expand-sm navbar-dark bg-dark pl-5 fixed-top">
      <div class="container-fluid">
        <a class="navbar-brand" href="index.php">WEB-TECHIE</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <ul class="navbar-nav custom-nav pl-3">
            ...
            <li class="nav-item custom-nav-item"><a href="#" class="nav-link">Live Editors</a></li>
            <li class="nav-item custom-nav-item"><a href="#" class="nav-link">Internship</a></li>
            ...
            <li class="nav-item custom-nav-item"><a href="#" class="nav-link">Facts</a></li>
          </ul>
        </div>
      </div>
</nav>