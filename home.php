...
<head>
    ...
    <style>
        ...
        * {
        ...
        .content.active .shadow.two {
            animation: shadow-two 0.6s ease-out;
            transform: perspective(1300px) rotateY(10deg) translateY(10px) translateZ(120px) scale(0.5);
        }
        ...
        .centerpart h2 {
            font-size: 32px;
            text-decoration: underline double 3px #F5A7A7;
...
<body>
    <div class="content">
        <div class="navibar">
            <div class="menu">
                <div class="namelogo">
                    <img src="images/logo.jpeg" alt="Web Techie" height="100px">
                    ...
                    <div class="overlay">
                        <div class="banner">
                            <div class="banner-sec-2">
                                <img src="images/imag.svg" height="300px">
                            </div>
                            <div class="banner-sec-1">
                                <?php
                                if(isset($_SESSION['is_login'])){
                                    echo ' <br><br><p>
                                    Ever been tired of surfing on the internet <br> only to realisethat you
                                    might have an idea <br> worth implementing but struggled with the <br>"how"
                                    aspect of it? We are here with new, <br>updated courses to help you with it.<br><br>
                                    </p>
                                    <a href="coursess.php"><button type="button">VIEW COURSES</button></a> 
                                    ';
                                }
                                else{
                                    echo'
                                    <div class="right">
                                    <div class="text1" align="left">Welcome to the world of</div>
                                    <div class="text2">WEB <span style="color:#f5a7a7">DEVELOPMENT.</span></div>
                                    <div class="text3">
                                        <span class="change_content"></span>
                                    </div>
                                    </div>
                                    <br>
                                    <p><a href="loginn.php"><button type="button">GET STARTED</button></a></p>
                                    ';
                                }
                                ?>
                                <!-- <div class="right">
                                ...
                                <br> -->
                                <!-- <p>
                                Ever been tired of surfing on the internet only to realise that you
                                might have an idea worth implementing but struggled with the "how"
                                aspect of it? We're here with new, updated courses to help you with it.  <br><br>-->
                                <!-- <p><a href="loginn.php"><button type="button">GET STARTED</button></a></p> -->
                            </div>
        ...
        <div class="links">
            <ul>
                ...
                ?>
                <li>
                    <a href="liveeditor.php" style="--i: 0.2s">Live Editors</a>
                </li>
                <li>
                    <a href="facts.php" style="--i: 0.25s">Facts</a>
                </li>
                <li>
                    <a href="https://docs.google.com/forms/d/e/1FAIpQLSeMc8p2dwcMhJdoys9zw7Al1EJfsLSDLbjbsJnNV2NQFRAHqQ/viewform?usp=sf_link" target="_blank" style="--i: 0.3s">Intership</a>
                </li>
                <li>
                    <a href="abt.php" style="--i: 0.35s">About Us</a>
                </li>
                <li>
                    <a href="home.php#contactform" style="--i: 0.4s">Contact Us</a>
                </li>
                <li>
                    <a href="feedback.php" style="--i: 0.45s">Feedback</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="intro">
            <div class="intro-sec-1">
                <h2>What is Webi-Techie?</h2>
                <p>Web-Fi is an online learning platform to provide people with opportunities
                    to explore their areas of interest. Coding has only gained importance over time
                    and will continue to grow as new ideas emerge everyday out of need or out of
                    pure interest. We are here to help you expand your skillset and not only work in
                    MNCs but also build an empire of your own.
                </p>
            </div>
            <div class="intro-sec-2">
                <h2>Importance of Webi-Techie?</h2>
                <p>We believe that it's important for any student to be exposed to new methods of
                    learning to make any domain interesting. Looking at the obsolete courses
                    offered by most of the online sites and the redundancy in them, we decided
                    to come up with solutions of our own. We emphasise on concepts which are new
                    and are bound to gain importance in the future.
                </p>
            </div>
        </div>
    </div>
    <div class="container-fluid bg-dark text-banner pl-4">
      <div class="row banner" style="padding-top:10px;padding-bottom:10px;padding-left:5px">
        <div class="col-sm">
          <h5 style="color:white"><i class="fas fa-book-open mr-3 ml-4"></i> Best Online Courses</h5>
        </div>
        <div class="col-sm">
          <h5 style="color:white"><i class="fas fa-users mr-3 ml-4"></i> Expert Instructors</h5>
        </div>
        <div class="col-sm">
          <h5 style="color:white"><i class="fas fa-keyboard mr-3 ml-4"></i> Lifetime Access</h5>
        </div>
        <div class="col-sm">
          <h5 style="color:white"><i class="fas fa-rupee-sign"></i>Cheap Price</h5>
        </div>
      </div>
    </div>
    <div class="centerpart">
        <div class="_12a0zdgp">
            <h2 data-scroll-id="why-ka-works" class="_1oyygy7d"><b>How Web-Techie Works ?</b></h2><br><br><br>
            <div class="_19c3vpn4">
                <div class="_3vgeo5o">
                    <div class="_5hffmqw">
                        <div class="_1wq0cf2d">
                            <svg fill="none" height="133" viewBox="0 0 148 133" width="148"
                                ...
                                <path
                                    ...
                                    stroke="#21242c" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
                        ...
                        <div class="_u65sq1a">
                            <h3 class="_eib2kdk">Personalized learning</h3><span class="_1jhgniwy">Students practice at
                                their own pace, first filling in gaps in their understanding and then accelerating their
                                learning.</span>
                        </div>
                    </div>
                </div><br><br><br>
                <div class="_1h26rsod"></div>
                <div class="_3vgeo5o">
                    <div class="_5hffmqw">
                        <div class="_1wq0cf2d"><svg fill="none" height="107" viewBox="0 0 116 107" width="116"
                                xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                <path
                        ...
                        <div class="_u65sq1a">
                            <h3 class="_eib2kdk">Trusted content</h3><span class="_1jhgniwy">Created by experts,
                                Web-Techies’s library of trusted, standards-aligned practice and lessons covers the
                                entire web-development domain.</span>
                        </div>
                    </div>
                </div><br><br><br>
                <div class="_1h26rsod"></div>
                <div class="_3vgeo5o">
                    <div class="_5hffmqw">
                        <div class="_1wq0cf2d"><svg fill="none" height="101" viewBox="0 0 133 101" width="133"
                                xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                <path
                                ...
                                <path d="M108 4.8928C109.505 4.6419 119.5 2.9771 119.5 5.3928" stroke="#21242c"
                                    stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></path>
                                <path d="M6 8C6.456 11.591 6.5 15.1398 6.5 18.75C6.5 19.1839 6.64387 22.7877 6 21.5"
                                    stroke="#21242c" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
                                </path>
                                <path
                        ...
                        <div class="_u65sq1a">
                            <h3 class="_eib2kdk">Tools to empower individuals</h3><span class="_1jhgniwy">With
                                Web-Techie,individuals can identify gaps in their understanding, tailor instruction, and
                                meet the needs of web-developer.</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <footer class="footer-distributed">
        ...
        <div class="footer-left">
            ...
            <h3>WEB<span>TECHIE</span></h3>

            <p class="footer-company-name">45% of the amount recieved from the courses offered are sent
                to NGOs to facilitate a better learning environment. Thank you
                for joining us.
            </p>
        </div>
        ...
        <div class="footer-center">
            ...
            <div>
                ...
                <p><a href="mailto:web-techie@gmail.com">web-techie@gmail.com</a></p>
            </div>
        ...
        <div class="footer-right">
            ...
            if(!isset($_SESSION['is_login'])){
                    echo '
                    <div class="add">
                <a class="box" href="addcourse.php" data-toggle="modal" data-target="#exampleModal"
                    style="text-decoration:none">
                    <span class="add-btn">ADMIN AREA</span>
                </a>
            </div>';
                }
                ?>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header" style="background:#f5a7a7">
                    <h5 class="modal-title" id="exampleModalLabel">Log In (Admin Side)</h5>
                ...
                <div class="modal-body">
                    <form action="#" id="form">
                        ...
                        <div class="input-icons" id = "email1-div">
                            <i class="fa fa-envelope icon"> </i> <label for="email">Admin Email</label>
                            <input class="input-field" name="email" type="text" placeholder="Email" id="email1">
                            <small id = "si-email">Error Msg</small>
                        </div>
                        <div class="input-icons" id = "pass1-div">
                            <i class="fa fa-key icon"></i><label for="pass">Admin Password</label>
                            <input class="input-field" name="pass" type="password" placeholder="Password"
                                id="password1">
                            <small id = "si-password">Error Msg</small>
                        </div>
